  ...
  return (
    <div className="social-links-bar">
      ...
      >
        ...
        <span className="social-links-tooltip" aria-hidden="true">Whitepaper</span>
      </a>
      <a
        href={TELEGRAM_URL}
        target="_blank"
      ...
      >
        ...
        <span className="social-links-tooltip" aria-hidden="true">Join Telegram</span>
      </a>
      <a
        href={GITHUB_URL}
        target="_blank"
      ...
      >
        ...
        <span className="social-links-tooltip" aria-hidden="true">Public repo</span>
      </a>
    </div>
  );
}
