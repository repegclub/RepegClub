...
pub enum ContractError {
    ...
    #[error("ticket_price must be greater than zero")]
    ...
    #[error("max_round_age_seconds must be greater than zero - a round can never accumulate players otherwise, since it would be immediately eligible for ExpireRound before a single ticket can be bought")]
    MaxRoundAgeSecondsMustBePositive {},
