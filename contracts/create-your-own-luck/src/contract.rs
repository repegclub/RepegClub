...
pub fn execute(
    ...
    match msg {
        ...
        ExecuteMsg::RevealDraw { preimage } => execute_reveal_draw(deps, env, info, preimage),
        ExecuteMsg::RequestExpireClosedRaffle {} => execute_request_expire_closed_raffle(deps, env, info),
        ExecuteMsg::FinalizeExpireClosedRaffle {} => execute_finalize_expire_closed_raffle(deps, env, info),
        ExecuteMsg::ClaimExpiredRaffle {} => claim_expired_raffle(deps, env, info),
